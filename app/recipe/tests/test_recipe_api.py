...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_tag_on_update(self):
        ...
        url = detailed_url(recipe_id=recipe.id)
    ...
    def test_create_recipe_with_existing_ingredient(self):
        """Test creating a new recipe with exiting ingredient."""
    ...
    def test_update_recipe_assign_igredient(self):
    ...
    def test_filter_by_ingredients(self):
        ...
        in1 = create_ingredient(user=self.user, name='Feta Cheese')
        in2 = create_ingredient(user=self.user, name='Chicken')
